...
function canWeDeliver(zipCode){
    ...
    for(i = 0; i < deliveryAreaZipCodes.length; i++){
        if(deliveryAreaZipCodes[i] === zipCode){
            return "You're in our delivery zone!"         // use return to ensure the for loop doesn't keep looping through
        } else {
...
//CODE HERE
deals[0].title = deals[0].title.replace("15", "10")   // assign the result to the first item in deals by denoting [0]
